...
class FilmControllerTest {
    ...
    void beforeEach() {
        validFilm = Film.builder()
                ...
                .releaseDate(LocalDate.of(1995, 12, 28)) // Дата после 28.12.1895
                .duration(120)
                .build();
    ...
    void createFilm_ZeroDuration_ReturnsBadRequest() {
        Film film = Film.builder()
                ...
                .releaseDate(LocalDate.of(2000, 1, 1))
                .duration(0) // Нулевая длительность фильма
                .build();
    ...
    void createFilm_DescriptionExactly200Chars_ReturnsOk() {
        String exact200Chars = "a".repeat(200); // Строка в 200 символов
